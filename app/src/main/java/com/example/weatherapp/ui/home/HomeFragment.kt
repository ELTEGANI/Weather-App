...
class HomeFragment : Fragment() {
    ...
    private fun setUiForWeatherInformation(currentWeather : Result<CurrentWeather>) {
         ...
         homeFragmentBinding.weatherTemperature.text = currentWeather.getOrNull()?.main?.temp.toString()+" "+
         ...
         homeFragmentBinding.humidityText.text = currentWeather.getOrNull()?.main?.humidity.toString()+" "+"%"
         homeFragmentBinding.pressureText.text = currentWeather.getOrNull()?.main?.pressure.toString()+" "+"hPa"
         homeFragmentBinding.windSpeedText.text = currentWeather.getOrNull()?.wind?.speed.toString()+" "+"m"
    }
